...
class ConPilot(AgentsFacet, CronFacet):
    ...
    def create_app(self, interval: int | None = None):
        ...
        Note:
            Delegates to :func:`con_pilot.app.create_app`, which wires the
        ...
        :rtype: `FastAPI`
        """
        from con_pilot.app import create_app as _create_app
...
# themselves live in ``con_pilot.{agents,cron}.service`` and are mixed in via
